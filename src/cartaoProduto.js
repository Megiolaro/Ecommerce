...
export function renderizarCatalogo(){
    for (const produtoCatalogo of catalogo) {
        const cartaoProduto = `<div class="border-solid m-3 w-48 flex flex-col p-2 justify-between shadow-xl shadow-slate-400 rounded-lg group id="produtc-${produtoCatalogo.id}">
        <img src="./assets/img/${produtoCatalogo.nomeArquivoImagem}" alt="imagem1" class="group-hover:scale-110 duration-300 my-3 rounded-lg">
